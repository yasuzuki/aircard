...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--host=arm-none-linux-gnueabi' '--prefix=/usr' '--exec-prefix=/usr' '--with-baseruby=/usr/bin/ruby' '--disable-rubygems' 'host_alias=arm-none-linux-gnueabi' 'CC=arm-none-linux-gnueabi-gcc' 'CXX=arm-none-linux-gnueabi-g++'"
  ...
  CONFIG["setup"] = "Setup"
  CONFIG["EXTSTATIC"] = ""
  CONFIG["STRIP"] = "arm-none-linux-gnueabi-strip -S -x"
  CONFIG["TRY_LINK"] = ""
  ...
  CONFIG["SET_MAKE"] = ""
  CONFIG["LN_S"] = "ln -s"
  CONFIG["NM"] = "arm-none-linux-gnueabi-nm"
  CONFIG["DLLWRAP"] = ""
  CONFIG["WINDRES"] = ""
  CONFIG["OBJCOPY"] = "arm-none-linux-gnueabi-objcopy"
  CONFIG["OBJDUMP"] = "arm-none-linux-gnueabi-objdump"
  CONFIG["ASFLAGS"] = ""
  CONFIG["AS"] = "arm-none-linux-gnueabi-as"
  CONFIG["AR"] = "arm-none-linux-gnueabi-ar"
  CONFIG["RANLIB"] = "arm-none-linux-gnueabi-ranlib"
  CONFIG["try_header"] = ""
  CONFIG["COUTFLAG"] = "-o "
  CONFIG["OUTFLAG"] = "-o "
  ...
  CONFIG["CXX"] = "arm-none-linux-gnueabi-g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = " $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L.  -rdynamic -Wl,-export-dynamic"
  CONFIG["CFLAGS"] = "$(cflags)"
  CONFIG["CC"] = "arm-none-linux-gnueabi-gcc"
  CONFIG["target_os"] = "linux-eabi"
  CONFIG["target_vendor"] = "none"
  CONFIG["target_cpu"] = "arm"
  CONFIG["target"] = "arm-none-linux-gnueabi"
  CONFIG["host_os"] = "linux-gnueabi"
  CONFIG["host_vendor"] = "none"
  CONFIG["host_cpu"] = "arm"
  CONFIG["host"] = "arm-none-linux-gnueabi"
  ...
  CONFIG["target_alias"] = ""
  CONFIG["host_alias"] = "arm-none-linux-gnueabi"
  CONFIG["build_alias"] = ""
